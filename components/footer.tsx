    ...
    <footer className="bg-card border-t border-border mt-12">
      <div className="max-w-7xl mx-auto px-4 py-8 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex gap-4 items-center">
          ...
          >
            <svg width="24" height="24" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="h-5 w-5">
          ...
          <a
            href="mailto:support@cleanair.com"
            className="hover:text-primary text-muted-foreground"
          >
            <svg width="24" height="24" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="h-5 w-5">
              <path d="M21 4H3a2 2 0 00-2 2v12a2 2 0 002 2h18a2 2 0 002-2V6a2 2 0 00-2-2zm0 2v.01L12 13 3 6.01V6h18z"/>
            </svg>
          </a>
        </div>
      </div>
